                    ...
                    <ul class="header__contact">
                        ...
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx"></a>+55 (91) xxxxx-xx41
                        </li>
                    </ul>
                    <ul class="header__contact">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Iniciando minha carreira como desenvolvedor web. Sou apaixonado pela web, atuando
                                como desenvolvedor com perfil Front-End/UX. E atualmente aplicando e aprimorando meus
                                conhecimentos em Back-End/UX e Design.</p>
                                    ...
                                    <div class="swiper-container js-carousel-clients">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/ifto1.jpg" style="background-color: #FFF;"
                                                        alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/ifto2.png"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/ifto3.jpg"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/ifto4.png" style="background-color: #FFF;"
                                                        alt="IFTO Logo" /></a>
                                            </div>
